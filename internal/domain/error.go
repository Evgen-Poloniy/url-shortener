...
var (
	...
	ErrLenURL        = errors.New("short URL must be exactly 10 characters long")
	ErrMissingScheme     = errors.New("URL must include scheme (://)")
	ErrInvalidURLFormat  = errors.New("invalid URL format")
	ErrMissingHost       = errors.New("URL must contain a host")
	ErrUnsupportedScheme = errors.New("unsupported protocol")
)
